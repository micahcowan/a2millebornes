 ...
 201  REMFURTHER CHANGES MADE BY MICAH COWAN (SHUFFLE PROGRESS, LINE NUMBER FIX, VARIOUS COUP FOURRE FIXES)
 300  HOME 
...
35005 CF(PR) = CF(PR) + 200:CI(PR,C) = 1:CP = 1
