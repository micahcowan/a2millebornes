 ...
 201  REMFURTHER CHANGES MADE BY MICAH COWAN (SHUFFLE PROGRESS, LINE NUMBER FIX)
 300  HOME 
...
3540  NEXT II
3550  REM@@@ LOAD THE REST OF THE DECK WITH 100'S
3560  FOR C = 15 TO TD: CR$(C) = "100": NEXT
3570  CR$(25) = "EXTRA TANK":REMTO TEST DELAYED SAFETY
3600  HOME 
...
5000 X = 9:A$ = "YOU     ":Z = 20:PR = 1:PO = 2:DS = 0:C = 0:HP(1) = 0
...
25550  RETURN 
25555 IF HP(PO) = 0 THEN 25559: REMONLY CF IF IMMEDIATELY AFTER HAZARD
25556 Y = 1:X = 6:A$ = "COUP FOURRE !!!   ": GOSUB 32000: ST$(PR) = "ROLL !"
25557  PRINT  CHR$ (7): PRINT  CHR$ (7)
25558 Y = 1:X = 6:A$ = "APPLE II MILLE BORNES": GOSUB 32000
25559  RETURN 
...
29720  INPUT YN$: HOME :Y = 2:X = 8:G8 = 1:A$ = "APPLE II MILLE BORNES": GOSUB 32000: R = R + 1: GOTO 1100
29800  REM
29900  END 
30000  REMREM REM
