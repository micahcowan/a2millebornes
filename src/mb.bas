...
3530  NEXT II
3540  REM@@@ LOAD THE REST OF THE DECK WITH 100'S
3550  FOR C = 15 TO TD: CR$(C) = "100": NEXT
3600  HOME 
...
40010  DATA "ROLL !","ROLL !","ACCIDENT  ","PUN PROOF ","SPARE TIRE","STOP      ","100"
40010  DATA "ROLL !","ROLL !","FLAT TIRE ","DRIV ACE  ","REPAIRS   ","100","100"
