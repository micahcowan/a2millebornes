...
35005 CF(PR) = CF(PR) + 200:CI(PR,C) = 1
35010 Y = 1:X = 6:A$ = "COUP FOURRE !!!   ": GOSUB 32000: ST$(PR) = "ROLL !"
35020  PRINT  CHR$ (7): PRINT  CHR$ (7)
35030 Y = 1:X = 6:A$ = "APPLE II MILLE BORNES": GOSUB 32000
35100  RETURN 
